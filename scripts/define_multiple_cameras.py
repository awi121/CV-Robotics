...
while True:
	...
	if k == 27:         
		...
		cv2.imwrite("outputs/Images/C2/C1.png", color_image_2)
		cv2.imwrite("outputs/Images/C3/C1.png", color_image_3)
		cv2.imwrite("outputs/Images/C4/C1.png", color_image_4)
		cv2.imwrite("outputs/Images/C5/C1.png", color_image_5)
		cv2.imwrite("outputs/Images/C2/D1.png", depth_image_2)
		cv2.imwrite("outputs/Images/C3/D1.png", depth_image_3)
		cv2.imwrite("outputs/Images/C4/D1.png", depth_image_4)
		cv2.imwrite("outputs/Images/C5/D1.png", depth_image_5)
		cv2.destroyAllWindows()